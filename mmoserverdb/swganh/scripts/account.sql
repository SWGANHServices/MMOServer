...
CREATE TABLE `account` (
  ...
  `account_username` varchar(32) NOT NULL DEFAULT '' COMMENT 'Account username',
  `account_password` varchar(64) NOT NULL COMMENT 'Account password',
  ...
  `account_email` varchar(64) NOT NULL DEFAULT '' COMMENT 'Account - User email',
  ...
  `account_lastcreate` datetime DEFAULT '0000-00-00 00:00:00' COMMENT 'Account - Last Character Create TimeStamp',
